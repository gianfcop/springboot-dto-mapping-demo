...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Spring Boot DTO Mapping Lite")
                .version("1.0.0")
                .description("Spring Boot demo application for clean DTO and Entity mapping using MapStruct, ModelMapper, and best practices.")
                .contact(new Contact()
                    .name("Your Name")
